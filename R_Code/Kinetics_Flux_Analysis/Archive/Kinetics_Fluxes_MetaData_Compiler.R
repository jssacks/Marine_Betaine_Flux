...
Dnorm.dat <- flux.kin.dat %>%
  ...
  select(Cruise, exp, Compound, mean_ks, Mean.Diss.Conc.nM, D_norm, D_norm_max, D_norm_min)

write_csv(Dnorm.dat, file = "Intermediates/DNorm_dat.csv")
