...
#TN397 (Gradeints 4)
nut.uw.file <- "Meta_Data/Enviro_Meta_Data/TN397/Gradients4_TN397_Nutrients_UW.csv"
pc.uw.file <- "Meta_Data/Enviro_Meta_Data/TN397/Gradients4_TN397_PPPCPN_UW.csv"
don.file <- "Meta_Data/Enviro_Meta_Data/TN397/TN397_Gradients4_NutrientsAndParticulates.csv"
ts.file <- "Meta_Data/Enviro_Meta_Data/TN397/TN397_SSS_SST.csv"
bact.file <- "Meta_Data/Enviro_Meta_Data/TN397/Influx_Stations_Gradients_2021v1_1.csv"
chla.file <- "Meta_Data/Enviro_Meta_Data/TN397/Gradients4_TN397_Optics_LISST_ACS_ECO.csv"
pp.13c.file <- "Meta_Data/Enviro_Meta_Data/TN397/Gradients4_TN397_15N13C.csv"
pp.14c.file <- "Meta_Data/Enviro_Meta_Data/TN397/Gradients4_TN397_14C_NPP_DailyOnDeck.csv"
...
#Write to CSV:
write_csv(full.interp, file = "Intermediates/G4_MetaData_Interpolated.csv")
